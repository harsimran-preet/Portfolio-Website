...
import contact from "../assets/images/me.jfif";
    ...
    <div className={styles.contact} id="contact">
      ...
      <div className={styles.contactSection}>
        ...
        <a
          ...
          href="mailto:harsimranpsingh@gmail.com"
          target="_blank"
          rel="noopener noreferrer"
        >
          harsimranpsingh@gmail.com
        </a>
        <br />
        <div className={styles.icons}>
          ...
          <a
            href="https://www.youtube.com/playlist?list=PL1DqUeoXTKY_VxDtMDIh8_9l8hMqNQTQN"
            rel="noreferrer"
            target="_blank"
          >
            <FaYoutube size="30px" />
